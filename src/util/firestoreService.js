...
// // Track language progress
// export const updateLanguageProgress = async (lessonId, progressData) => {
//   try {
//     const userId = auth().currentUser?.uid;
//     if (!userId) throw new Error('No authenticated user found');
...
import firestore from '@react-native-firebase/firestore';
import auth from '@react-native-firebase/auth';
import {saveLessonProgress} from './storage';
...
//     console.log('Updating progress for lesson:', lessonId); // Debug log
...
//     console.log('Progress updated successfully'); // Debug log
//   } catch (error) {
//     console.error('Firestore Error:', error);
//     throw error;
//   }
